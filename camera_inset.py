...
from ffmpeg_utils import fundo_desfocado
...
def inset_filtergraph(orig_w, orig_h, out_w, out_h, box, camera_ratio=None):
    ...
    return (
        ...
        # Desfocado em 1/4 da resolucao desde 23-set-2026, como o do GENERAL:
        # ver `ffmpeg_utils.fundo_desfocado`.
        f"[bga]{fundo_desfocado(out_w, out_h, 14)}[bg];"
