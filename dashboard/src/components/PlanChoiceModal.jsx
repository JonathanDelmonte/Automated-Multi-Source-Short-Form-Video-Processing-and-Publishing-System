        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="card p-5 flex flex-col border-brass">
            <div className="flex items-center justify-between mb-1">
              <h3 className="font-display uppercase tracking-wide text-lg text-ink">free</h3>
          ...
          <div className="card p-5 flex flex-col">
            <div className="flex items-center justify-between mb-1">
              <h3 className="font-display uppercase tracking-wide text-lg text-ink">paid plans</h3>
