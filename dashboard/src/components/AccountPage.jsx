    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <h2 className="font-display uppercase tracking-wide text-2xl text-ink leading-tight">Your account</h2>
      ...
      {topups.length > 0 && (
        <div className="card p-6">
          <h3 className="font-display uppercase tracking-wide text-lg text-ink mb-1 flex items-center gap-2"><Plus size={16} className="text-brass" /> Buy more minutes</h3>
