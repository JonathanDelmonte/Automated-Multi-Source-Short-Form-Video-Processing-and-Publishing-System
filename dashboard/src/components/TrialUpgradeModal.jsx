    ...
    <Modal isOpen onClose={onClose} eyebrow="TRIAL" size="md">
      {done ? (
        <div className="text-center py-4">
          ...
          <h2 className="font-display uppercase tracking-wide text-xl text-ink mb-1">You're all set</h2>
        ...
        <>
          ...
          <h2 className="font-display uppercase tracking-wide text-xl text-ink mb-1">You've used your free trial minutes</h2>
